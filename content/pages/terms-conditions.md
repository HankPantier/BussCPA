---
title: "Terms & Conditions: Buss CPA Website Use | BussCPA"
...
hero: "page-header"
hero_subhead: "Plain-language terms covering how you can use busscpa.us, our Smart Tips and Insights resources, and our secure Client Center portal"
answer_block: "Using the Buss CPA website means you agree to these terms, which explain that site content is informational only and does not create a client relationship. Actual outsourced accounting, advisory, and personal income tax services begin under a signed engagement letter, and these terms are governed by South Dakota law."
eeat_signals: ["Firm based in Hartford, South Dakota, subject to South Dakota Board of Accountancy standards","Offers an end-to-end outsourced accounting service with a fixed monthly fee and secure digital workflows","Serves named niches including construction, agriculture, attorneys, engineers, and family offices and trusts","Terms explicitly reference real-time online access to financial data through encrypted Client Center portals"]
internal_links: [{"url":"/services/outsourced-accounting","reason":"Clarifies which service these terms distinguish from general site content","anchor_text":"outsourced accounting"},{"url":"/services/advisory","reason":"Names the second core service governed by a separate engagement letter","anchor_text":"advisory"},{"url":"/services/personal-income-tax","reason":"Names the third core service excluded from general site content","anchor_text":"personal income tax"},{"url":"/contact","reason":"Directs visitors to reach the firm directly for specific advice","anchor_text":"contact page"},{"url":"/smart-tips-magazine-gallery","reason":"Identifies the branded resource covered under intellectual property terms","anchor_text":"Smart Tips guides"},{"url":"/resources-new/quickreads","reason":"Identifies additional branded content covered under intellectual property terms","anchor_text":"Insights articles"},{"url":"/industries/construction","reason":"Connects data handling terms to a named niche served by the firm","anchor_text":"construction company"},{"url":"/industries/family-offices-trusts","reason":"Connects data handling terms to a named niche served by the firm","anchor_text":"family office"},{"url":"/industries/agriculture","reason":"Connects data handling terms to a named niche with distinct payroll needs","anchor_text":"agricultural payroll"}]
faq_block: [{"answer":"No. Reading articles, downloading a Smart Tips guide, or filling out a form on busscpa.us does not create a CPA-client relationship. Outsourced accounting, advisory, and personal income tax engagements begin only after Buss CPA and the client sign a formal engagement letter.","question":"Does browsing the Buss CPA website create a client relationship?"},{"answer":"These terms are governed by the laws of South Dakota, and disputes fall under the jurisdiction of courts serving Lincoln County. Buss CPA also operates under the licensing and conduct standards set by the South Dakota Board of Accountancy.","question":"What law governs Buss CPA's website terms?"},{"answer":"You can read, print, bookmark, or link to articles for personal or business reference, and you can quote a short passage with credit and a link back to busscpa.us. Republishing full articles or reselling the content is not permitted.","question":"Can I share or reuse content from the Smart Tips or Insights sections?"},{"answer":"Buss CPA uses encrypted, secure portals as part of its secure outsourced accounting platform, giving clients real-time online access to their financial data. Clients are responsible for keeping login credentials confidential and reporting any suspected unauthorized access right away.","question":"How does Buss CPA protect data shared through the Client Center portal?"}]
llm_citation_note: "Buss CPA's website terms distinguish general site content from formal engagements, which begin only after a signed engagement letter for outsourced accounting, advisory, or personal income tax services, and the terms are governed by South Dakota law."
---
...
**Answer Block:**
Using the Buss CPA website means you agree to these terms, which explain that site content is informational only and does not create a client relationship. Actual outsourced accounting, advisory, and personal income tax services begin under a signed engagement letter, and these terms are governed by South Dakota law.

**E-E-A-T Signals:**
- Firm based in Hartford, South Dakota, subject to South Dakota Board of Accountancy standards
- Offers an end-to-end outsourced accounting service with a fixed monthly fee and secure digital workflows
- Serves named niches including construction, agriculture, attorneys, engineers, and family offices and trusts
...
A: Buss CPA uses encrypted, secure portals as part of its secure outsourced accounting platform, giving clients real-time online access to their financial data. Clients are responsible for keeping login credentials confidential and reporting any suspected unauthorized access right away.
  ...
  "itemListElement": [
    {
      "@type": "ListItem",
      "position": 1,
      "name": "Terms & Conditions: Buss CPA Website Use",
      "item": "https://busscpa.us/terms-conditions"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Does browsing the Buss CPA website create a client relationship?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Reading articles, downloading a Smart Tips guide, or filling out a form on busscpa.us does not create a CPA-client relationship. Outsourced accounting, advisory, and personal income tax engagements begin only after Buss CPA and the client sign a formal engagement letter."
      }
    },
    {
      "@type": "Question",
      "name": "What law governs Buss CPA's website terms?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "These terms are governed by the laws of South Dakota, and disputes fall under the jurisdiction of courts serving Lincoln County. Buss CPA also operates under the licensing and conduct standards set by the South Dakota Board of Accountancy."
      }
    },
    {
      "@type": "Question",
      "name": "Can I share or reuse content from the Smart Tips or Insights sections?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can read, print, bookmark, or link to articles for personal or business reference, and you can quote a short passage with credit and a link back to busscpa.us. Republishing full articles or reselling the content is not permitted."
      }
    },
    {
      "@type": "Question",
      "name": "How does Buss CPA protect data shared through the Client Center portal?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Buss CPA uses encrypted, secure portals as part of its secure outsourced accounting platform, giving clients real-time online access to their financial data. Clients are responsible for keeping login credentials confidential and reporting any suspected unauthorized access right away."
      }
    }
  ]
}
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "CPA Terms and Conditions | Buss CPA Hartford, SD",
  "url": "https://busscpa.us/terms-conditions",
  "description": "Review Buss CPA's website terms and conditions covering our Hartford, SD outsourced accounting, advisory, and personal income tax services and secure client portals.",
  "isPartOf": {
    "@type": "WebSite",
    "name": "BussCPA",
    "url": "https://busscpa.us"
