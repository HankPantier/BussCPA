...
answer_block: "BussCPA is a CPA firm in Hartford, South Dakota, offering tax preparation, outsourced accounting, and advisory services built for project-based engineering firms. Services include fixed-fee outsourced accounting (BASE) with job costing by project, entity and personal tax planning, and partner compensation advisory, all backed by secure online access to financial data."
