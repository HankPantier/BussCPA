...
That's why the analysis draws on the same financial data tracked through your bookkeeping and payroll, real numbers instead of estimates pulled together in January. For clients already working with us on [entity type analysis](/services/advisory/entity-type-analysis) or [QuickBooks setup](/services/advisory/quickbooks-setup), retirement plan analysis is one more piece of a strategy built around where the business is headed, not just where it's been.
